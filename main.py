...
def get_value():
    ...
    if((team1=='KKR' and team2=='CSK') or (team1=='CSK' and team2=='KKR')):
        ...
        if(new_predictionKKR > new_predictionMI):
            i='KKR'
        else:
            i='MI'
        ...
        if(new_predictionKKR > new_predictionDD):
            i='KKR'
        else:
            i='DD'
        ...
        if(new_predictionKKR > new_predictionRCB):
            i='KKR'
        else:
            i='RCB'
        ...
        if(new_predictionKKR > new_predictionKXIP):
            i='KKR'
        else:
            i='KXIP'
        ...
        if(new_predictionKKR > new_predictionSRH):
            i='KKR'
        else:
            i='SRH'
    ...
    if((team1=='CSK' and team2=='MI') or (team1=='MI' and team2=='CSK')):
        ...
        new_predictionCSK = lin.predict(sc.transform(np.array([[101,2,13,42,11]])))
        new_predictionRCB = lin.predict(sc.transform(np.array([[98,2,13,42,10]])))
        if(new_predictionCSK > new_predictionRCB):
            i='CSK'
        else:
            i='RCB'
        ...
        new_predictionDD = lin.predict(sc.transform(np.array([[101,3,13,39,19]])))
        new_predictionRCB = lin.predict(sc.transform(np.array([[98,2,13,42,10]])))
        if(new_predictionDD > new_predictionRCB):
            i='DD'
        else:
            i='RCB'
